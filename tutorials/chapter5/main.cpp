...
int main(int argc, char *argv[])
{
	...
	/* 콜백 등록 */
	// 윈도우 크기 변경 시 발생 콜백
	glutReshapeFunc(Tutorials::Chapter5::Callbacks::HandleWindowReshapeEvent);
	// 렌더링 콜백
    	glutDisplayFunc(Tutorials::Chapter5::Callbacks::HandleDisplayEvent);
