...
int main(int argc, char **argv)
{
	...
	Texture *texNX = g_rm.LoadTexture(SCENE::SKYBOX_PATH[1]);
	Texture *texNZ = g_rm.LoadTexture(SCENE::SKYBOX_PATH[0]);
	Texture *texPY = g_rm.LoadTexture(SCENE::SKYBOX_PATH[5]);
